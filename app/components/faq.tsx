...
const Faq = () => {
    ...
    <main className="mt-28 max-md:mx-2 max-2xl:mx-4 text-slate-200 max-md:mt-10">
        ...
        <div className="collapse collapse-arrow border-t border-t-slate-300 border-transparente my-2 rounded-none">
            ...
            <div className="max-md:py-4 max-md:px-2 py-8 px-8 bg-dark-gradient rounded-md">
                <p className="mb-4">
                ...
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">1. <b>Eye catching design :</b><br/> We create modern and appealing designs conveying an image of professionalism giving confidence to customers</p>
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">2. <b>Custom Functionalities:</b><br/> To implement some functionalities you want you may need to buy a plugin or hire a developer to implement it. However, in Weezac you do not pay for a plugin.</p>
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">3. <b>Cost-Effective Solutions:</b><br/> Weezac’s pricing plans are designed to be cost-effective for institutions, often including many necessary features as standard without the need for additional expensive plugins or custom development.</p>
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">4. <b>SEO Optimization:</b><br/> Weezac ensures superior SEO optimization, enhancing your website's visibility and search engine rankings to attract more visitors and drive engagement.</p>
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">5. <b>Performance:</b><br/> We develop with performance in mind, ensuring fast load times and a seamless user experience for your visitors, reducing bounce rates.</p>
        ...
        <div className="collapse collapse-arrow border-t border-t-slate-300 border-transparente my-2 rounded-none">
            ...
            <div className="collapse-content"> 
            <div className="bg-dark-gradient py-8 max-md:px-2 px-8 rounded-md">
        ...
        <div className="collapse collapse-arrow border-t border-t-slate-300 border-transparente my-2 rounded-none">
            ...
            <div className="collapse-content"> 
            <div className="py-8 max-md:px-2 px-8 bg-dark-gradient rounded-md">
                ...
                <h3 className="text-xl font-bold max-md:ml-4 ml-8 mt-4">Institutional Website:</h3>
                <p className="max-md:ml-2 ml-12 p-2 py-1">
                ...
                <p className="max-md:ml-2 ml-12 p-2 py-1">Typical Duration: 1-2 weeks</p>

                <h3 className="text-xl font-bold max-md:ml-4 ml-8 mt-4">E-commerce Website:</h3>
                <p className="max-md:ml-2 ml-12 p-2 py-1">
                An e-commerce website requires more functionality, such as product listings, a shopping cart, and payment integration.            
                </p>
                <p className="max-md:ml-2 ml-12 p-2 py-1">Typical Duration: 4-8 weeks</p>

                <h3 className="text-xl font-bold max-md:ml-4 ml-8 mt-4">Web Application:</h3>
                <p className="max-md:ml-2 ml-12 p-2 py-1">
                A web application involves custom functionality and interactive features, making the development process more complex.
                </p>
                <p className="max-md:ml-2 ml-12 p-2 py-1">Typical Duration: 8-16 weeks</p>

                <h3 className="text-xl font-bold max-md:ml-4 ml-8 mt-4">Content Management System: (CMS)</h3>
                <p className="max-md:ml-2 ml-12 p-2 py-1">
                ...
                <p className="max-md:ml-2 ml-12 p-2">Typical Duration: 8-12 weeks</p>
            </div>
            </div>
        </div>
        ...
        <div className="collapse collapse-arrow border-t border-t-slate-300 border-transparente my-2 rounded-none">
            ...
            <div className="py-8 max-md:px-2 px-8 bg-dark-gradient rounded-md">
                ...
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">1. <b>Regular Updates:</b> Keeping your site updated with the latest software and security patches.</p>
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">2. <b>Performance Monitoring:</b> Ensuring fast load times and efficient server performance.</p>
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">3. <b>Security Enhancements:</b> Implementing measures to protect against malware and other threats.</p>
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">4. <b>Content Updates:</b> Managing and updating your website content as needed.</p>
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">5. <b>Technical Support:</b> Providing assistance with any technical issues or questions.</p>
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">6. <b>Backup Services:</b> Regularly backing up your website to safeguard your data.</p>
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">7. <b>Feature Enhancements:</b> Adding new features and functionalities as your business grows.</p>
        ...
        <div className="collapse collapse-arrow border-t border-t-slate-300 border-transparente my-2 rounded-none">
            ...
            <div className="py-8 max-md:px-2 px-8 bg-dark-gradient rounded-md">
                ...
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">1. <b>Domain Registration:</b> We can help you choose and register the perfect domain name for your website.</p>
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">2. <b>Website Hosting:</b> We provide reliable hosting solutions to ensure your website is fast, secure, and always available.</p>
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">3. <b>Setup and Configuration:</b> We handle all the technical setup and configuration, so you don’t have to worry about the details.</p>
                <p className="max-md:ml-4 max-md:mt-2 ml-8 mt-4">4. <b>Ongoing Support:</b> We offer ongoing support and management for your hosting and domain needs.</p>
